...
export class FirstMigration1718226361194 implements MigrationInterface {
    name = 'FirstMigration1718226361194'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transaction" RENAME CONSTRAINT "UQ_f7c8e3dbb6752a8cd2c1049b075" TO "UQ_79cc8332af9a1ab7540f1523a4f"`);
        await queryRunner.query(`ALTER TABLE "transaction" DROP CONSTRAINT "UQ_79cc8332af9a1ab7540f1523a4f"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transaction" ADD CONSTRAINT "UQ_79cc8332af9a1ab7540f1523a4f" UNIQUE ("source_account_id")`);
        await queryRunner.query(`ALTER TABLE "transaction" RENAME CONSTRAINT "UQ_79cc8332af9a1ab7540f1523a4f" TO "UQ_f7c8e3dbb6752a8cd2c1049b075"`);
